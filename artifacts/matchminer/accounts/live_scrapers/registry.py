...
class ScraperSpec:
    ...
    bi_weekly_default_on: bool = False # default date form to rolling-window mode
    default_range_days: int = 0        # blank scheduled date-range window (0 = app default)
...
SPECS = {
    ...
    "sportradar": ScraperSpec(
        slug="sportradar",
        input_kind=INPUT_DATE_RANGE,
        runner_path="accounts.live_scrapers.sportradar:run",
        secret_label="SportRadar API key",
        secret_env_var="SPORTRADAR_API_KEY",
