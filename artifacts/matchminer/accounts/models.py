...
class Run(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["-started_at"], name="acct_run_started_desc_idx"),
            models.Index(fields=["status", "created_at"], name="acct_run_status_created_idx"),
        ]
        constraints = [
...
class Notification(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["recipient", "-created_at"], name="acct_notif_rec_created_idx"),
        ]
