...
urlpatterns = [
    ...
    path(
        "qa/notifications/bulk-delete/",
        qa_views.notifications_bulk_delete,
        name="qa_notifications_bulk_delete",
    ),
    path(
        "qa/notifications/<int:pk>/delete/",
        qa_views.notification_delete,
        name="qa_notification_delete",
    ),
    path(
